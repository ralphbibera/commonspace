...
const meta = {
	title: "Foundation/Workspace Header",
...
export const Project: Story = {
	args: {
		title: "Commonspace",
		subtitle: "2 conversations · 1 folder · working directory",
		mark: <CommonspaceLogo decorative className="size-5" />,
		actions: (
			<button
				type="button"
				className="grid size-11 place-items-center rounded-full border-0 bg-transparent text-muted-foreground hover:bg-muted"
			>
