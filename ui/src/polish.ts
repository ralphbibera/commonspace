...
.csp-dialog {
  ...
  --csp-hover: var(--dsw-alias-interactive-bg-hover, rgba(17, 17, 17, 0.05));
  --csp-active: color-mix(in srgb, var(--csp-fg) 9%, transparent);
  --csp-sidebar-fg: var(--csp-fg);
  --csp-sidebar-muted: var(--csp-muted);
  --csp-sidebar-hover: var(--csp-hover);
  --csp-sidebar-active: var(--csp-active);
  --csp-accent: #2f6feb;
...
.csp-agent-status[data-status='running'] { color: var(--csp-success); }
.csp-agent-status[data-status='stopped'] { color: var(--csp-warning); }
...
.csp-search-filters select,
.csp-search-kind-filters button {
  min-height: 28px;
  box-sizing: border-box;
...
.csp-search-kind-filters button[aria-pressed='true'] {
  border-color: color-mix(in srgb, var(--csp-accent) 48%, var(--csp-border-soft));
  background: color-mix(in srgb, var(--csp-accent) 12%, var(--csp-surface));
  color: var(--csp-accent);
}
...
.csp-search-result-main mark {
  border-radius: 2px;
  background: color-mix(in srgb, var(--csp-accent) 20%, transparent);
  color: inherit;
}

.csp-search-result-main .csp-search-result-receipt {
  color: color-mix(in srgb, var(--csp-subtle) 78%, transparent);
  font-size: 9px;
}
...
.csp-app-toast {
  ...
  border-radius: 10px;
  background: color-mix(in srgb, var(--dsw-alias-bg-base, #ffffff) 92%, #dc2626);
  box-shadow: 0 10px 32px rgba(20, 22, 26, 0.16);
  color: #b42318;
  font-size: 12px;
  line-height: 16px;
  text-align: center;
...
.csp-global-settings .csp-run-defaults > label,
.csp-dm-search {
...
.csp-global-settings .csp-run-defaults > label input,
.csp-global-settings .csp-run-defaults > label select,
.csp-dm-search input {
  width: 100% !important;
...
.csp-project-add-folder:hover:not(:disabled) {
  background: var(--csp-hover);
}

.csp-project-add-folder:disabled {
  color: var(--csp-muted);
}

.csp-project-add-folder + .csp-project-local-pill {
  margin-left: 0;
}
...
.csp-project-folder-card-head > span {
  min-width: 0;
}

.csp-project-folder-add {
  min-height: 34px;
  flex: none;
  padding: 0 11px;
  border: 1px solid var(--csp-border);
...
.csp-project-folder-add:hover:not(:disabled) {
  background: var(--csp-hover);
}

.csp-project-folder-add:disabled {
  cursor: wait;
  opacity: 0.6;
}
...
.csp-project-content--workbench {
  display: flex;
  overflow: hidden;
  padding: 16px;
}

.csp-project-workbench,
.csp-project-workbench-empty {
...
.csp-project-workbench-empty strong,
.csp-project-workbench-empty p,
.csp-project-pane-state strong,
.csp-project-pane-state p,
.csp-project-preview-empty strong,
.csp-project-preview-empty p {
  display: block;
  margin: 0;
}
...
.csp-project-file-rail,
.csp-project-preview-pane {
  display: flex;
  min-width: 0;
  min-height: 0;
  flex-direction: column;
...
.csp-project-file-rail {
  ...
  background: color-mix(in srgb, var(--csp-shell-bg, #fafafa) 62%, var(--csp-surface));
}

.csp-project-pane-header {
  display: flex;
  min-height: 62px;
  box-sizing: border-box;
  align-items: center;
...
.csp-project-pane-header > div {
  min-width: 0;
}

.csp-project-pane-header strong,
.csp-project-pane-header small {
  display: block;
  overflow: hidden;
  text-overflow: ellipsis;
  white-space: nowrap;
...
.csp-project-pane-header select {
  min-width: 0;
  max-width: 152px;
  height: 32px;
...
.csp-project-breadcrumbs > span {
  display: inline-flex;
  align-items: center;
  gap: 3px;
}

.csp-project-breadcrumbs i {
  color: var(--csp-subtle);
  font-style: normal;
  font-size: 10px;
}

.csp-project-breadcrumbs button {
...
.csp-project-breadcrumbs button:hover,
.csp-project-breadcrumbs button[aria-current='page'] {
  background: var(--csp-hover);
  color: var(--csp-fg);
}

.csp-project-file-list {
  min-height: 0;
  flex: 1;
  overflow: auto;
  padding: 7px;
  scrollbar-color: color-mix(in srgb, var(--csp-fg) 14%, transparent) transparent;
}

.csp-project-file-row {
  display: grid;
  width: 100%;
  min-height: 38px;
  box-sizing: border-box;
...
.csp-project-file-row:hover {
  background: var(--csp-hover);
}

.csp-project-file-row[aria-pressed='true'] {
  background: var(--csp-accent-soft);
  box-shadow: inset 2px 0 0 var(--csp-accent);
}

.csp-project-file-row > small {
  color: var(--csp-subtle);
  font-size: 9px;
}

.csp-project-file-glyph {
  display: inline-grid;
  width: 28px;
  height: 23px;
  place-items: center;
...
.csp-project-file-glyph--directory {
  border-color: color-mix(in srgb, var(--csp-accent) 28%, var(--csp-border));
  color: var(--csp-accent);
  font-family: inherit;
  font-size: 17px;
  font-weight: 500;
...
.csp-project-preview-header > span {
  flex: none;
  padding: 4px 7px;
  border: 1px solid var(--csp-border);
  border-radius: 999px;
...
.csp-project-preview-body {
  ...
  overflow: auto;
  place-items: center;
  background: color-mix(in srgb, var(--csp-shell-bg, #fafafa) 72%, var(--csp-surface));
}

.csp-project-preview-body > img,
.csp-project-preview-body > video,
.csp-project-media-change img,
.csp-project-media-change video {
  display: block;
...
.csp-project-preview-empty,
.csp-project-pane-state {
  align-self: center;
  justify-self: center;
  padding: 24px;
  color: var(--csp-fg);
...
.csp-project-preview-empty > span {
  display: inline-grid;
  width: 38px;
  height: 38px;
  margin-bottom: 10px;
...
.csp-project-pane-state--error {
  color: var(--csp-danger);
}

.csp-project-limit-note {
  padding: 8px 10px;
  color: var(--csp-muted);
  font-size: 9px;
  text-align: center;
...
.csp-project-refresh:hover {
  background: var(--csp-hover);
  color: var(--csp-fg);
}

.csp-project-change-summary {
  display: flex;
  min-height: 37px;
  box-sizing: border-box;
  align-items: center;
...
.csp-project-change-summary strong {
  color: var(--csp-fg);
  font-weight: 650;
}

.csp-project-change-summary > span {
  overflow: hidden;
  text-overflow: ellipsis;
  white-space: nowrap;
}

.csp-project-change-row {
  min-height: 48px;
}

.csp-project-change-row .csp-project-file-name strong,
.csp-project-change-row .csp-project-file-name small {
  display: block;
  overflow: hidden;
  text-overflow: ellipsis;
  white-space: nowrap;
...
.csp-project-change-mark--added,
.csp-project-change-mark--untracked {
  background: color-mix(in srgb, var(--csp-success) 11%, transparent);
  color: var(--csp-success);
}

.csp-project-change-mark--deleted,
.csp-project-change-mark--conflicted {
  background: color-mix(in srgb, var(--csp-danger) 10%, transparent);
  color: var(--csp-danger);
}

.csp-project-change-mark--renamed {
  background: color-mix(in srgb, var(--csp-warning) 11%, transparent);
  color: var(--csp-warning);
}

.csp-project-change-counts {
  display: inline-flex;
  align-items: center;
  gap: 5px;
  font-family: ui-monospace, SFMono-Regular, Menlo, Monaco, Consolas, monospace;
...
.csp-project-change-counts b {
  color: var(--csp-success);
  font-weight: 650;
}

.csp-project-change-counts em {
  color: var(--csp-danger);
  font-style: normal;
  font-weight: 650;
}

.csp-project-change-counts i {
  color: var(--csp-subtle);
  font-style: normal;
}

.csp-project-preview-body--diff {
  display: block;
  overflow: auto;
  background: var(--csp-surface);
}
...
.csp-project-diff-line--add {
  background: color-mix(in srgb, var(--csp-success) 10%, transparent);
  color: color-mix(in srgb, var(--csp-success) 72%, #111);
}

.csp-project-diff-line--remove {
  background: color-mix(in srgb, var(--csp-danger) 9%, transparent);
  color: color-mix(in srgb, var(--csp-danger) 76%, #111);
}

.csp-project-diff-line--meta,
.csp-project-diff-line--hunk {
  color: var(--csp-accent);
}

.csp-project-diff-line--hunk {
  margin: 5px 0;
  background: color-mix(in srgb, var(--csp-accent) 7%, transparent);
}

.csp-project-media-change {
  display: grid;
  min-height: 220px;
  place-items: center;
  padding: 12px;
...
.csp-project-media-change small {
  justify-self: start;
  color: var(--csp-muted);
  font-size: 9px;
  font-weight: 650;
...
.csp-thread-open:hover {
  background: color-mix(in srgb, var(--csp-accent) 14%, transparent);
}

.csp-thread-open--unread,
.csp-thread-open--unread:hover {
  background: var(--csp-accent-soft);
  color: var(--csp-accent);
  box-shadow: none;
}

.csp-thread-unread-indicator {
  position: absolute;
  top: -3px;
  right: -3px;
  width: 9px;
  height: 9px;
  box-sizing: border-box;
  border: 2px solid var(--csp-surface);
  border-radius: 50%;
  background: var(--csp-danger);
}
...
.csp-live-activity-row.is-expanded {
  border-color: color-mix(in srgb, var(--csp-accent) 32%, var(--csp-border));
  box-shadow: inset 2px 0 0 var(--csp-accent);
}

button.csp-live-activity-trigger:hover {
  background: var(--csp-hover);
}

.csp-live-activity-heading > span,
.csp-live-activity-summary,
.csp-live-activity-chevron,
.csp-live-activity-empty {
  color: var(--csp-muted);
}

.csp-live-activity-panel {
  border-color: var(--csp-border-soft);
  background: color-mix(in srgb, var(--csp-accent) 3%, var(--csp-surface));
}
...
.csp-project-add-folder:focus-visible,
.csp-project-file-row:focus-visible,
.csp-project-breadcrumbs button:focus-visible,
.csp-project-refresh:focus-visible,
.csp-project-pane-header select:focus-visible,
.csp-project-folder-add:focus-visible,
...
.csp-live-activity-trigger:focus-visible {
...
@media (max-width: 720px) {
  ...
  .csp-project-workbench {
    ...
    grid-template-rows: minmax(300px, 42dvh) minmax(360px, 1fr);
  }
...
.csp-followup-queue {
  ...
  border: 1px solid var(--csp-border);
  border-radius: 12px;
  background: color-mix(in srgb, var(--csp-panel) 92%, var(--csp-accent) 8%);
}

.csp-followup-queue > header,
.csp-followup-item,
.csp-followup-item > div,
.csp-delivery-controls,
.csp-run-signal {
  display: flex;
  align-items: center;
  gap: 8px;
...
.csp-followup-queue > header { justify-content: space-between; margin-bottom: 6px; }
.csp-followup-item { padding: 6px 0; border-top: 1px solid var(--csp-border); }
.csp-followup-item > span { color: var(--csp-accent); font-size: 11px; font-weight: 700; text-transform: uppercase; }
.csp-followup-item > p { flex: 1; min-width: 0; margin: 0; overflow: hidden; text-overflow: ellipsis; white-space: nowrap; }
.csp-followup-item button,
.csp-delivery-controls button { border: 0; border-radius: 6px; background: transparent; color: var(--csp-muted); padding: 4px 7px; cursor: pointer; }
.csp-followup-item button:hover,
.csp-delivery-controls button[aria-pressed="true"] { background: color-mix(in srgb, var(--csp-accent) 16%, transparent); color: var(--csp-ink); }
.csp-delivery-controls { flex-wrap: wrap; }
.csp-run-signal { margin-top: 8px; color: var(--csp-muted); font-size: 12px; }
.csp-run-signal--attention { color: var(--csp-danger); }
