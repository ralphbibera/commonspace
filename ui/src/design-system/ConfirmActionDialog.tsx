    ...
    <AlertDialog open={open} onOpenChange={onOpenChange}>
      <AlertDialogContent className="max-w-[460px] gap-0 rounded-md p-0 ring-1 ring-border shadow-[var(--shadow-high)] sm:max-w-[460px]">
        <AlertDialogHeader className="place-items-start gap-2 px-[18px] py-5 text-left">
          <AlertDialogTitle className="font-heading text-xl font-bold">{title}</AlertDialogTitle>
          <AlertDialogDescription className="max-w-[390px] text-[13px] leading-5">{description}</AlertDialogDescription>
        </AlertDialogHeader>
